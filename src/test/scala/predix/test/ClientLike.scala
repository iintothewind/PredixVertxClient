...
trait ClientLike extends FlatSpecLike with Matchers with BeforeAndAfterEach {
  ...
  val webClientOptions: WebClientOptions = WebClientOptions().setSsl(true).setKeepAlive(true).setTrustAll(true).setFollowRedirects(true).setTryUseCompression(true).setProxyOptions(proxyOptions)
  //val webClientOptions: WebClientOptions = WebClientOptions().setSsl(true).setKeepAlive(true).setTrustAll(true).setFollowRedirects(true).setTryUseCompression(true)
