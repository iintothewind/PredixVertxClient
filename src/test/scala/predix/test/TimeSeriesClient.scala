...
//      (ws: WebSocket) => {
//        Try {
//          ws.write(Buffer.buffer("{\"messageId\":\"1453338376222\",\"body\":[{\"name\":\"Compressor-2015:CompressionRatio\"," +
//            "\"datapoints\":[[1453338376222,10,3],[1453338377222,10,1]],\"attributes\":{\"host\":\"server1\",\"customer\":\"Acme\"}}]}"))
//        } match {
